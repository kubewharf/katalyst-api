...
var katalystverticalpodautoscalersResource = schema.GroupVersionResource{Group: "autoscaling.katalyst.kubewharf.io", Version: "v1alpha2", Resource: "katalystverticalpodautoscalers"}
...
func (c *FakeKatalystVerticalPodAutoscalers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.KatalystVerticalPodAutoscaler, err error) {
	...
	return obj.(*v1alpha2.KatalystVerticalPodAutoscaler), err
}
...
func (c *FakeKatalystVerticalPodAutoscalers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.KatalystVerticalPodAutoscalerList, err error) {
	...
	list := &v1alpha2.KatalystVerticalPodAutoscalerList{ListMeta: obj.(*v1alpha2.KatalystVerticalPodAutoscalerList).ListMeta}
	for _, item := range obj.(*v1alpha2.KatalystVerticalPodAutoscalerList).Items {
