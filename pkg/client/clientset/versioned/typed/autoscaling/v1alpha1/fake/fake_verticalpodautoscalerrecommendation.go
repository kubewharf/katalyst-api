...
func (c *FakeVerticalPodAutoscalerRecommendations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VerticalPodAutoscalerRecommendation, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VerticalPodAutoscalerRecommendationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) Create(ctx context.Context, verticalPodAutoscalerRecommendation *v1alpha1.VerticalPodAutoscalerRecommendation, opts v1.CreateOptions) (result *v1alpha1.VerticalPodAutoscalerRecommendation, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) Update(ctx context.Context, verticalPodAutoscalerRecommendation *v1alpha1.VerticalPodAutoscalerRecommendation, opts v1.UpdateOptions) (result *v1alpha1.VerticalPodAutoscalerRecommendation, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) UpdateStatus(ctx context.Context, verticalPodAutoscalerRecommendation *v1alpha1.VerticalPodAutoscalerRecommendation, opts v1.UpdateOptions) (*v1alpha1.VerticalPodAutoscalerRecommendation, error) {
	obj, err := c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeVerticalPodAutoscalerRecommendations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(verticalpodautoscalerrecommendationsResource, c.ns, listOpts)
...
func (c *FakeVerticalPodAutoscalerRecommendations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VerticalPodAutoscalerRecommendation, err error) {
	obj, err := c.Fake.
