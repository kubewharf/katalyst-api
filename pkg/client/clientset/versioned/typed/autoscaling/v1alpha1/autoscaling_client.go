...
type AutoscalingV1alpha1Interface interface {
	...
	VerticalPodAutoscalerRecommendationsGetter
}

// AutoscalingV1alpha1Client is used to interact with features provided by the autoscaling.katalyst.kubewharf.io group.
type AutoscalingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AutoscalingV1alpha1Client) KatalystVerticalPodAutoscalers(namespace string) KatalystVerticalPodAutoscalerInterface {
	return newKatalystVerticalPodAutoscalers(c, namespace)
}

func (c *AutoscalingV1alpha1Client) VerticalPodAutoscalerRecommendations(namespace string) VerticalPodAutoscalerRecommendationInterface {
	return newVerticalPodAutoscalerRecommendations(c, namespace)
}
