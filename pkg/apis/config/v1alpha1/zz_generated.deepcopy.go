...
func (in *FragMemConfig) DeepCopyInto(out *FragMemConfig) {
	*out = *in
	if in.EnableSettingFragMem != nil {
		in, out := &in.EnableSettingFragMem, &out.EnableSettingFragMem
		*out = new(bool)
		**out = **in
	}
	if in.SetMemFragScoreAsync != nil {
		in, out := &in.SetMemFragScoreAsync, &out.SetMemFragScoreAsync
		*out = new(int64)
		**out = **in
	}
...
func (in *HostWatermarkConfig) DeepCopyInto(out *HostWatermarkConfig) {
	*out = *in
	if in.EnableSettingHostWatermark != nil {
		in, out := &in.EnableSettingHostWatermark, &out.EnableSettingHostWatermark
		*out = new(bool)
		**out = **in
	}
	if in.SetVMWatermarkScaleFactor != nil {
		in, out := &in.SetVMWatermarkScaleFactor, &out.SetVMWatermarkScaleFactor
		*out = new(int64)
		**out = **in
	}
	if in.SetVMWatermarkBoostFactor != nil {
		in, out := &in.SetVMWatermarkBoostFactor, &out.SetVMWatermarkBoostFactor
		*out = new(int64)
		**out = **in
	}
	if in.SetVMExtFragThreshold != nil {
		in, out := &in.SetVMExtFragThreshold, &out.SetVMExtFragThreshold
		*out = new(int64)
		**out = **in
	}
