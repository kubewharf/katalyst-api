...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&LoadAwareArgs{}, func(obj interface{}) { SetObjectDefaults_LoadAwareArgs(obj.(*LoadAwareArgs)) })
	...
	scheme.AddTypeDefaultingFunc(&QoSAwareNodeResourcesFitArgs{}, func(obj interface{}) {
		SetObjectDefaults_QoSAwareNodeResourcesFitArgs(obj.(*QoSAwareNodeResourcesFitArgs))
	})
	return nil
}

func SetObjectDefaults_LoadAwareArgs(in *LoadAwareArgs) {
	SetDefaults_LoadAwareArgs(in)
}
...
func SetObjectDefaults_QoSAwareNodeResourcesBalancedAllocationArgs(in *QoSAwareNodeResourcesBalancedAllocationArgs) {
	SetDefaults_QoSAwareNodeResourcesBalancedAllocationArgs(in)
}

func SetObjectDefaults_QoSAwareNodeResourcesFitArgs(in *QoSAwareNodeResourcesFitArgs) {
	SetDefaults_QoSAwareNodeResourcesFitArgs(in)
}
