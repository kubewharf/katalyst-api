...
func (in *NodeProfileDescriptorList) DeepCopyInto(out *NodeProfileDescriptorList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NodeProfileDescriptor, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeProfileDescriptorList) DeepCopy() *NodeProfileDescriptorList {
	...
	out := new(NodeProfileDescriptorList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeProfileDescriptorSpec) DeepCopy() *NodeProfileDescriptorSpec {
	...
	out := new(NodeProfileDescriptorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeProfileDescriptorStatus) DeepCopyInto(out *NodeProfileDescriptorStatus) {
	*out = *in
	if in.NodeMetrics != nil {
		...
		*out = make([]ScopedNodeMetrics, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PodMetrics != nil {
		...
		*out = make([]ScopedPodMetrics, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeProfileDescriptorStatus) DeepCopy() *NodeProfileDescriptorStatus {
	...
	out := new(NodeProfileDescriptorStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourcePool) DeepCopyInto(out *ResourcePool) {
	*out = *in
	if in.MinAllocatable != nil {
		in, out := &in.MinAllocatable, &out.MinAllocatable
		*out = new(v1.ResourceList)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[v1.ResourceName]resource.Quantity, len(*in))
	...
	if in.MaxAllocatable != nil {
		in, out := &in.MaxAllocatable, &out.MaxAllocatable
		*out = new(v1.ResourceList)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[v1.ResourceName]resource.Quantity, len(*in))
...
func (in *Resources) DeepCopyInto(out *Resources) {
	*out = *in
	...
	if in.ResourcePackages != nil {
		in, out := &in.ResourcePackages, &out.ResourcePackages
		*out = make([]ResourcePackage, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in TopologyAllocation) DeepCopyInto(out *TopologyAllocation) {
	{
		in := &in
		*out = make(TopologyAllocation, len(*in))
		for key, val := range *in {
			var outVal map[string]ZoneAllocation
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(map[string]ZoneAllocation, len(*in))
				for key, val := range *in {
					(*out)[key] = *val.DeepCopy()
				}
			}
