...
func (in *ContainerControlledResourcesPolicy) DeepCopyInto(out *ContainerControlledResourcesPolicy) {
	*out = *in
	...
	if in.BufferPercents != nil {
		in, out := &in.BufferPercents, &out.BufferPercents
		*out = new(int32)
		**out = **in
	}
	return
...
func (in *ContainerResourcePolicy) DeepCopyInto(out *ContainerResourcePolicy) {
	*out = *in
	if in.ControlledResourcesPolicy != nil {
		in, out := &in.ControlledResourcesPolicy, &out.ControlledResourcesPolicy
...
func (in *ResourceRecommendStatus) DeepCopyInto(out *ResourceRecommendStatus) {
	*out = *in
	in.LastRecommendationTime.DeepCopyInto(&out.LastRecommendationTime)
